...
class Machine:
    def __init__(self, program: ProgramImage) -> None:
        ...
        # Harvard Architecture: Data Memory размер в байтах
        ...
        # Load initial data segment into data memory
        ...
        # A7 is the Stack Pointer. It starts at the top of the data memory (grows downwards).
